...
func TestUnmarshal(t *testing.T) {
	var xmlOriginal []byte
	{
		...
		<catalogocuentas:Catalogo xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:catalogocuentas="http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas" xsi:schemaLocation="http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas/CatalogoCuentas_1_3.xsd" Anio="2015" Mes="1" RFC="AAA010101AAA" Version="1.3" Sello="TEST" noCertificado="12345678901234567890" Certificado="TEST">
