...
func TestUnmarshal(t *testing.T) {
	...
	{
		xmlOriginal = []byte(`
			<cartaporte20:CartaPorte Version="2.0" TranspInternac="No" TotalDistRec="1963">
				<cartaporte20:Ubicaciones>
					<cartaporte20:Ubicacion TipoUbicacion="Origen" RFCRemitenteDestinatario="IXS7607092R5" FechaHoraSalidaLlegada="2021-12-15T12:24:21">
						<cartaporte20:Domicilio Calle="Filomeno Mata 922" NumeroExterior="35" Referencia="Filomeno Mata 922, Ejidos de Santa María Aztahuacán, DIF" Estado="DIF" Pais="MEX" CodigoPostal="02900" />
					</cartaporte20:Ubicacion>
					<cartaporte20:Ubicacion TipoUbicacion="Destino" RFCRemitenteDestinatario="AMX120216J89" FechaHoraSalidaLlegada="2021-12-15T03:00:00" DistanciaRecorrida="1963">
						<cartaporte20:Domicilio Calle="TAMAULIPAS 7" NumeroExterior="7" Referencia="TAMAULIPAS 7, CENTRO, SON" Estado="SON" Pais="MEX" CodigoPostal="83001" />
					</cartaporte20:Ubicacion>
				</cartaporte20:Ubicaciones>
				<cartaporte20:Mercancias PesoBrutoTotal="1" UnidadPeso="KGM" NumTotalMercancias="1">
					<cartaporte20:Mercancia BienesTransp="50425400" Descripcion="CACAHUATE RUNNER 38/42 B R" Cantidad="1" ClaveUnidad="KGM" PesoEnKg="1" />
					<cartaporte20:Autotransporte PermSCT="TPAF02" NumPermisoSCT="09381581/080002">
						<cartaporte20:IdentificacionVehicular ConfigVehicular="T3S2" PlacaVM="LE57937" AnioModeloVM="2008" />
						<cartaporte20:Seguros AseguraRespCivil="Seguros Atlas" PolizaRespCivil="MS1-1-7-38294" AseguraMedAmbiente="Seguros Atlas" PolizaMedAmbiente="MS1-1-7-38294" AseguraCarga="Seguros Atlas" PolizaCarga="MS1-2-2-1353" />
						<cartaporte20:Remolques>
							<cartaporte20:Remolque SubTipoRem="CTR004" Placa="6HU3452" />
						</cartaporte20:Remolques>
					</cartaporte20:Autotransporte>
				</cartaporte20:Mercancias>
				<cartaporte20:FiguraTransporte>
					<cartaporte20:TiposFigura TipoFigura="01" RFCFigura="VAEE770919BE9" NombreFigura="MANUEL ENRIQUE VELAZQUEZ ESPINOSA" NumLicencia="N03626578" />
				</cartaporte20:FiguraTransporte>
